...
def random_order_book_entry(count: int = 10, 
...
def random_order_book_initializer(code="HK.00700", name="腾讯控股", **args) -> StockOrderBook:
...
def direction_generator(volumn_delta: int, volumn_max: int, noise: StandardError) -> int:
    """
...
def random_next_order_book(order_book: StockOrderBook, price_unit: float = 0.01, **args) -> StockOrderBook:
